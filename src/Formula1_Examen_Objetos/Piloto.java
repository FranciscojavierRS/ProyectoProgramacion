...
public class Piloto implements Comparable<Piloto> {
	...
	@Override
	public int compareTo(Piloto pilotoAComparar) {
		
		if (this.puntos!= pilotoAComparar.getPuntos()) {
			return pilotoAComparar.getPuntos()-this.puntos;
		}else {
			return this.nombre.compareTo(pilotoAComparar.getNombre());
		}
