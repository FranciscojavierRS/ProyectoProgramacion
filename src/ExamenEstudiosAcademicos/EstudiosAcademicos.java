...
public class EstudiosAcademicos {
	...
	public static void main(String[] args) {
        ...
        while (!nombreClase.equalsIgnoreCase("fin")) {
        	...
        	String nombreAlumno = "";
        	 while (!nombreAlumno.equalsIgnoreCase("fin")) {
        		 ...
        		 int notaGlobal = (int) (notaObtenidaExamenFianl*0.6+notaObtenidaControl*0.3+notaClase*0.1);
        ...
        System.out.println("(B) El tutor de la clase con menor porcentaje de suspensos es: "+
        nombreTutorMenorSuspensos+" Con un porcentaje de "+menorPorcentajeSuspensos*100);
        System.out.println("(C) El número de clases con más aprobados que suspensos es: "+numeroDeClasesMayorAprobados);
        
        porcentajeAlumnosExamenFinalAprobado=(float)alumnoExamenFinalAprobado/numeroAlumnosCentro;
        System.out.println("(D) El porcentaje total de alumnos con el final aprobado de todo el centro es:  "+porcentajeAlumnosExamenFinalAprobado*100);
        ...
        if (tresPrimerosAprobados) {
        	...
        	System.out.println(" No hay alguna clase donde los tres primeros alumnos introducidos tienen el control aprobado.");
        }
